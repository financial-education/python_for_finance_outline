...
*** Exercise: Calculate market depth via Kyle's lambda. Use AlphaVantage API to get data.



Old video and notebook.  Coinbase API Packages are now broken.
[[https://youtu.be/GlyMFMAGxhc][Session Video]]
[[https://colab.research.google.com/drive/1GGXpVBhSIypRslVcjWB5TYcexeRxZlyY][Colab Notebook]]  <--- Broken, do not use.
